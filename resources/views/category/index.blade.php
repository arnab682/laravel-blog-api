    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form  id="editDataForm">@csrf
                <div class="form-group">
                        <input type="text" class="form-control" id="e_name" placeholder="Edit Category">
...
<div class="modal fade" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <input type="text" class="form-control" id="view_name" placeholder="Add New Category" readonly>
            </div>
    ...
    <script>
        let url = 'http://127.0.0.1:8002/api'
        console.log(url);
    ...
    $('body').on('submit','#addNewDataForm',function(e){
        ...
        .catch(function (error) {
            ...
            if(error.response.data.errors.name){
                $('#error').text(error.response.data.errors.name);
            }
        });
